...
def generate_output(tokenizer, model, question):
    messages = [
        {
            "role": "system",
            "content": (
                "You are a precise study assistant. Answer clearly for exam revision. "
                "Do not use emojis, hashtags, or motivational comments."
            ),
        },
        {
            "role": "user",
